...
public class MessagesFragment extends Fragment {
    ...
    public static MessagesFragment newInstance(String param1, String param2, boolean param3) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_combo_main, container, false);
        mRecyclerListView = (RecyclerView) rootView.findViewById(R.id.my_recycler_view);
        mRecyclerListView.setHasFixedSize(false);

        mRecyclerListView.setLayoutManager(new LinearLayoutManager(this.getContext()));
